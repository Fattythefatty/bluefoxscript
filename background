...
function UILibrary.Main(PrjName,HideKey)
	...
	Main.Name = "Main"
	Main.Parent = Library
	Main.BackgroundColor3 = Color3.fromRGB(27,27,87)
	...
	HideMain.BackgroundColor3 = Color3.fromRGB(255,127,0)
	...
	FadeBackgroundFrame.BackgroundColor3 = Color3.fromRGB(27,27, 87)
	...
	LeftPart.BackgroundColor3 = Color3.fromRGB(27,27,87)
	...
	ProjectName.BackgroundColor3 = Color3.fromRGB(31,93,93)
	...
	ButtonsTab.BackgroundColor3 = Color3.fromRGB(31,93,93)
	...
	List.ScrollBarImageColor3 = Color3.fromRGB(255,127,0)
	...
	function Tabs.Loader()
		...
		for i = 1,4 do
			...
			Circle.BackgroundColor3 = Color3.fromRGB(255,127,0)
	...
	function Tabs.Nofitication(Text)
		...
		Nofitication.BackgroundColor3 = Color3.fromRGB(30,90,90)
		...
		NofiticationButton.AutoButtonColor = true
	...
	function Tabs.NewTab(TabName)
		...
		Elements.ScrollBarImageColor3 = Color3.fromRGB(255,127,0)
		Elements.ScrollBarImageTransparency = 0.5

		FadeFrame.Name = "FadeFrame"
		FadeFrame.Parent = Frame
		FadeFrame.BackgroundColor3 = Color3.fromRGB(27,27,87)
		...
		for index,page in next,Pages:GetChildren() do
			if page.Name ~= "UIPageLayout" and (page.Name == Frame.Name and index == 2) then
				...
				TweenService:Create(TabButton,TweenInfo.new(0.25),{BackgroundTransparency = 0.3,BackgroundColor3 = Color3.fromRGB(255,127,0)}):Play()	
		...
		local function ReColorOtherBtns()
			for _,Button in next,List:GetDescendants() do
				if Button.Name == "bd" and Button.Parent.Name ~= TabButton.Name then
					TweenService:Create(Button.Parent,TweenInfo.new(0.1),{BackgroundTransparency = 1,BackgroundColor3 = Color3.fromRGB(0,255,255)}):Play()
					Button.Value = false	
				end
			end
		...
		function ElementsLib.NewSection(SectionName)
			...
			Section.BackgroundColor3 = Color3.fromRGB(30,90,90)
			...
			SectionElements.BackgroundColor3 = Color3.fromRGB(30,90,90)
			...
			function InSection.NewToggle(ToggleText,UserFunc,defbool)
				...
				Toggle.BackgroundColor3 = Color3.fromRGB(31,93,93)
				...
				Toggle.Text = ""
				Toggle.TextColor3 = Color3.fromRGB(255,127,0)
				Toggle.TextSize = 14.000


				DownLine.Parent = Toggle
				DownLine.BackgroundColor3 = Color3.fromRGB(132,132,132)
				...
				ToggleLabel.BorderColor3 = Color3.fromRGB(255,127,0)
				...
				Checker.BackgroundColor3 = Color3.fromRGB(255,127,0)
				...
				CheckerStroke.Color = Color3.fromRGB(126,126,126)
				...
				HideChecker.BackgroundColor3 = Color3.fromRGB(30,90,90)
			...
			function InSection.NewLabel(LabelText,IsScaled,LabelTextSize,LabelTextColor)
				...
				Label.BorderColor3 = Color3.fromRGB(81,126,159)
			...
			function InSection.NewSlider(SliderText,min,max,precise,UserFunc,defvalue)
				...
				Slider.BackgroundColor3 = Color3.fromRGB(31,93,93)
				...
				SliderLabel.BorderColor3 = Color3.fromRGB(255,127,0)
				...
				Sliding.BackgroundColor3 = Color3.fromRGB(43,129,129)
				...
				CircleStroke.Color = Color3.fromRGB(43,129,129)
				...
				HideColor.BackgroundColor3 = Color3.fromRGB(43,129,129)
				...
				Progress.BackgroundColor3 = Color3.fromRGB(255,127,0)
			...
			function InSection.NewDropdown(placeholder,Selectables,func,IsMulti)
				...
				Dropdown.BackgroundColor3 = Color3.fromRGB(31,93,93)
				...
				Frame_2.BackgroundColor3 = Color3.fromRGB(132,132,132)
				...
				Tsd.BackgroundColor3 = Color3.fromRGB(27,27,87)
				...
				CloseButton.TextColor3 = Color3.fromRGB(255,127,0)
				...
				DropdownLineTop.BackgroundColor3 = Color3.fromRGB(132,132,132)
				...
				DropdownLineBottom.BackgroundColor3 = Color3.fromRGB(132,132,132)
				...
				local function NewSelectable(Text,val)
					...
					SelectableButton.AutoButtonColor = true
					...
					SecFrame.BackgroundColor3 = Color3.fromRGB(132,132,132)
					...
					ChoosedCircle.BackgroundColor3 = Color3.fromRGB(255,127,0)
					...
					InnerCircle.BackgroundColor3 = Color3.fromRGB(255,127,0)
					...
					ChoosedCircleStroke.Color = Color3.fromRGB(132,132,132)
			...
			function InSection.NewButton(btnText,func)
				...
				Button.MouseButton1Click:Connect(function()
					...
					if not IsMouseOn then
						TweenService:Create(Button,TweenInfo.new(0.25),{BackgroundTransparency = 1,BackgroundColor3 = Color3.fromRGB(0,255,255)}):Play()
					else
						TweenService:Create(Button,TweenInfo.new(0.25),{BackgroundTransparency = 0.98,BackgroundColor3 = Color3.fromRGB(0,255,255)}):Play()
					end
				end)

				Button.MouseButton1Down:Connect(function()
					TweenService:Create(Button,TweenInfo.new(0.25),{BackgroundTransparency = 0.3,BackgroundColor3 = Color3.fromRGB(255,127,0)}):Play()
				end)
